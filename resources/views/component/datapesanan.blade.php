                ...
                <div class="card-body">
                    <form action="{{ route('export.pesanan', request()->query()) }}" method="GET"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label for="example-text-input" class="form-control-label dateselect col-12"></label>
                                <a class="btn btn-sm ms-auto bg-dark text-white mt-2" type="button"
                                    onclick="dataExport()">
                                    <i class="text-sm fa-solid fa-file-excel" style="margin-right: 10px"></i>Export to
                                    Excel</a>
                                <script>
                                    // Fungsi untuk menampilkan konfirmasi sebelum menambah data
                                    function dataExport() {
                                        document.getElementById('filter-pesanan').submit();
                                    }
                                </script>
                            </div>
                            <script>
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <button href="/proses-selesai/{{ $order->id }}"
                                                class="text-white badge badge-md fa-solid fa-check bg-gradient-secondary"
                                                data-toggle="tooltip" data-original-title="Edit"
                                                style="border: solid 1px" disabled>
                                            </button>
                                                <button type="button"
                                                    class="text-white badge badge-md fa-solid fa-xmark bg-gradient-secondary"
                                            ...
                                            @else
                                            <a href="/proses-selesai/{{ $order->id }}"
                                                class="text-dark badge badge-md fa-solid fa-check"
                                                data-toggle="tooltip" data-original-title="Edit"
                                                style="border: solid 1px">
                                            </a>
                                                <a type="button" class="text-dark badge badge-md fa-solid fa-xmark"
                                                    data-toggle="tooltip" data-original-title="Hapus"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#cancelPesanan{{ $order->id }}"
                                                    style="border: solid 1px">
                                                                ...
                                                                <div style="max-height: 300px; overflow-y: auto;">
                                                                    @if ($order->jenis_pesanan == 'Menu Spesial')
                                                                        @php
                                                                            ...
                                                                            $menus = Menu::whereIn('id', $menu)->orderBy('tanggal_berlaku', 'asc')->get();
                                                                            $k = 0;
                                                                            $i = 0;
