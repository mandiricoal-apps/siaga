...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h4 class="font-weight-bolder text-white mb-0 mt-3">Manajemen Data Snack</h4>
        </nav>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="../images/risol.jpg" class="avatar avatar-sm me-3"
                                                            alt="user1">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Risol</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary text-s"
                                                    data-toggle="tooltip" data-original-title="Detail">
                                                    <span class="badge badge-md bg-gradient-info"><i
                                                            class="fa-solid fa-eye"></i></span>
                                                </a>
                                                <a href="/catering/data-snack/ubah" class="text-secondary text-s"
