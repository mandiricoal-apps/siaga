        ...
        <div class="row justify-content-center">
            <div class="col-10 text">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/catering/data-menu-spesial/update/{{ $menus->id }}" method="POST" id="form-menu">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_makanan" class="form-select" required>
                                            <option selected value="1"
                                                {{ old('jenis_makanan', $menus->jenis_makanan) == 1 ? 'selected' : '' }}>
                                                Menu Spesial</option>
                                            <option value="2"
                                                {{ old('jenis_makanan', $menus->jenis_makanan) == 2 ? 'selected' : '' }}>
                                                Snack</option>>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" cols="50" name="deskripsi">{{ $menus->deskripsi }}</textarea>
                                    </div>
                                </div>
                            </div>
