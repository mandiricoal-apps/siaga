                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0 fw-bold fs-4"> Form Ubah Data Menu Spesial</p>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Gambar Menu
                                        Spesial</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nama Menu
                                        Spesial</label>
                                    <input class="form-control" type="text" value="Nasi Goreng">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Deskripsi</label>
                                    <textarea class="form-control" rows="4" cols="50">Nasi Goreng</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-header pb-0 mb-5">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-sm ms-auto bg-gradient-warning"
                                href="/catering/data-menu-spesial">Simpan</a>
                        </div>
                    </div>
                </div>
            </div>
