...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse w-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'home.dashboard' ? 'active' : '' }}"
                    href="/dashboard">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'riwayatpesanan' ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'kelolapengguna' ? 'active' : '' }}"
